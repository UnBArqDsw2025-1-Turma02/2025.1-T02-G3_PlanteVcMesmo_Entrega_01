...
<label><input type="checkbox" checked >[Davi Araújo Bady Casseb][dcasseb]</label><br>
...
| :----: | :--: | :-------: | :---: | 
| `1.0`| 09/04 | Criação do documento| [Gabriel Fernando de Jesus Silva][MMcLovin] e [Mateus Vieira Rocha da Silva][mateusvrs] |  
